"""
Django settings for e_commerce_template_44685 project.
...
ROOT_URLCONF = 'e_commerce_template_44685.urls'
...
WSGI_APPLICATION = 'e_commerce_template_44685.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "e_commerce_template_44685 API",
    "DESCRIPTION": "API documentation for e_commerce_template_44685 App",
    "VERSION": "v1",
}
