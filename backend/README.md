...
## Project Structure
    ...
    ├── e_commerce_template_44685  # Django project configurations
...
1. Clone this repo and `cd e_commerce_template_44685`
...
2. Clone this repo and `cd e_commerce_template_44685`
